...
param(
  ...
  [switch]$AllUsers,                # search all C:\Users\...\Chrome profiles (use for SYSTEM runs)
  [string]$DebugLog = "C:\Users\Public\custom\chrome_export_debug.log"
)
...
# ===================== CONFIG =====================
$SQLite   = "C:\Users\Public\sqlite3.exe"
$OutDir   = "C:\Users\Public\custom"
...
$UrlsLog = Join-Path $OutDir "chrome_urls.ndjson"
$VLLog   = Join-Path $OutDir "chrome_visited_links.ndjson"
$VSLog   = Join-Path $OutDir "chrome_visit_source.ndjson"
...
function Get-Targets {
  ...
  # Final safety net: coerce blanks to placeholders
...
# ---------- 20s loop ----------
Write-DebugLog ("Started. AllUsers={0}; BootstrapEmitExisting={1}; Interval={2}" -f $AllUsers, $BootstrapEmitExisting.IsPresent, $IntervalSeconds)
while ($true) {
